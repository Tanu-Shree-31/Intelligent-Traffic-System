...
tfnet=TFNet(options)
inputPath=r'D:\Wipro\ITS\model-its\Adaptive-Traffic-Signal-Timer\Code\YOLO\darkflow\test_images'
outputPath=r'D:\Wipro\ITS\model-its\Adaptive-Traffic-Signal-Timer\Code\YOLO\darkflow\output_images'
